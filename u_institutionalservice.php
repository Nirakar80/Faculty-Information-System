...
<head>
  ...
  <body>
    ...
    <div class="main">
      ...
      <form action="../modify/up_institutionalservice.php" method="post">

        <label> Type of Activity: </label>
        <select name="activity" id="activity">
            <option value="---">- - - </option>
            <option value="Committee Member" <?php if($ActivityType == 'Committee Member'){ echo ' selected="selected"'; }?> >Committee Member</option>
            <option value="Committee Chair" <?php if($ActivityType == 'Committee Chair'){ echo ' selected="selected"'; }?> >Committee Chair</option>
            <option value="Search & Hiring Committee" <?php if($ActivityType == 'Search & Hiring Committee'){ echo ' selected="selected"'; }?> >Search & Hiring Committee</option>
            <option value="Mentoring Activities" <?php if($ActivityType == 'Mentoring Activities'){ echo ' selected="selected"'; }?> >Mentoring Activities</option>
            <option value="Other Institutional Activities" <?php if($ActivityType == 'Other Institutional Activities'){ echo ' selected="selected"'; }?> >Other Institutional Activities</option>
        </select><br>

        <label> Committee: </label>
        <input type="text" name="committee" value='<?php echo $Committee ?>'/><br>
        ...
        <select name="scope" id="scope">
            <option value="---">- - - </option>
            <option value="Department" <?php if($Scope == 'Department'){ echo ' selected="selected"'; }?> >Department</option>
            <option value="College" <?php if($Scope == 'College'){ echo ' selected="selected"'; }?> >College</option>
            <option value="University" <?php if($Scope == 'University'){ echo ' selected="selected"'; }?> >University</option>
            <option value="State-Wide" <?php if($Scope == 'State-Wide'){ echo ' selected="selected"'; }?> >State-Wide</option>
        </select><br>
        ...
        <?php 
            echo "
            <a href='l_institutionalservice.php'>Return to List</a>
            </form>
        </div>
    </body>
</html>";
