...
<html>
 <head>
   <title>Chapter, Case, Reading, or Supplement Form</title>
  ...
  <body>
    <div class="main">
      <h1>Results</h1><hr>
      <br>
      <form action="../modify/up_chapters.php" method="post">
        
        <label> Category:</label>
        <select name="category" id="category">
          <option value="---">- - - </option>
          <option value="Chapter" <?php if($Category == 'Chapter' ){ echo ' selected="selected"'; } ?>>Chapter</option>
          <option value="Case" <?php if($Category == 'Case' ){ echo ' selected="selected"'; } ?>>Case</option>
          <option value="Reading" <?php if($Category == 'Reading' ){ echo ' selected="selected"'; } ?>>Reading</option>
          <option value="Supplement" <?php if($Category == 'Supplement' ){ echo ' selected="selected"'; } ?>>Supplement</option>
        </select><br><br>
        ...
        <?php 
            echo "
            <a href='l_chapters.php'>Return to List</a>
            </form>
    </div>
    </body>
</html>";
