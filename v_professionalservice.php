...
$upsql=mysql_query("select * from ProfessionalService where PSID= $upinput" );
...
<head>
   ...
   <link rel="stylesheet" href="rlist.css">
    ...
    <body>
        ...
        <div class="navbar">
            <ul>
              <li><a href="../Lists/l_professionalservice.php">Back</a></li>
        ...
        <h2 class="mini-title">Detailed View</h2>
            ...
            <div class="card">
                <div class="container">
                    ...
                    <?php echo "<p><a href='u_professionalservice.php?id=".$PSID."'><button>Edit</button></a>&nbsp;&nbsp;&nbsp;
                    <a href='../modify/d_professionalservice.php?id=".$PSID."'><button>Delete</button></a></p></p>" ?>
                </div>
            </div>
