...
<html>
<head>
   <title>Articles in Progress Form</title>
  ...
  <body>
    <div class="main">
      <h1> Results</h1><hr>
      <br>
      <form action="../modify/up_articlesinprogress.php" method="post">
        
        <label> Title of Paper: </label>
        <input  type="text" name="titleOfPaper" maxlength="100" size="100" value='<?php echo $TitleofPaper; ?>'/><br><br>
        ...
        <select name="typeOfActivity" id="typeOfActivity">
          <option value="---">- - - </option>
          <option value="Circular" <?php if($TypeofActivity == 'Circular'){ echo ' selected="selected"'; } ?>>Circular/Newsletter</option>
          <option value="Academic" <?php if($TypeofActivity == 'Academic'){ echo ' selected="selected"'; } ?>>Journal: Academic</option>
          <option value="In House" <?php if($TypeofActivity == 'In House'){ echo ' selected="selected"'; } ?>>Journal: In-House</option>
          <option value="Pedagogical" <?php if($TypeofActivity == 'Pedagogical'){ echo ' selected="selected"'; } ?>>Pedagogical</option>
          <option value="Professional" <?php if($TypeofActivity == 'Professional'){ echo ' selected="selected"'; } ?>>Journal: Professional/Practitioner</option>
          <option value="Note" <?php if($TypeofActivity == 'Note'){ echo ' selected="selected"'; } ?>>Note/Abstract</option>
          <option value="Review" <?php if($TypeofActivity == 'Review'){ echo ' selected="selected"'; } ?>>Review/Critique/Discussion</option>
          <option value="Technological" <?php if($TypeofActivity == 'Technological'){ echo ' selected="selected"'; } ?>>Technological</option>
        </select><br><br>
        
        <label> Paper Description: </label><br>
        <textarea type="textarea" rows="11" cols ="80" name="paperDescription" maxlength="250" value='<?php echo $PaperDescription; ?>'><?php echo $PaperDescription?></textarea><br><br>
        ...
        <?php 
            echo "
            <a href='l_articlesinprogress.php'>Return to List</a>
            </form>
        </div>
    </body>
        </html>";
