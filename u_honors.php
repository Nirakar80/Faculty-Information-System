  ...
  <body>
    ...
    <div class="main">
      ...
      <br>
        ...
        <form action="../modify/up_honors.php" method="post">
            ...
            <select name="type" id="type" value='<?php echo $Type ?>'>
                <option value="---">- - - </option>
                <option value="Honor" <?php if($Type == 'Honor'){ echo ' selected="selected"'; }?> >Honor</option>
                <option value="Award" <?php if($Type == 'Award'){ echo ' selected="selected"'; }?>>Award</option>
                <option value="Scholarship" <?php if($Type == 'Scholarship'){ echo ' selected="selected"'; }?>>Scholarship</option>
            </select><br>
            
            <label> Category: </label>
            <select name="category" id="category" value='<?php echo $Category ?>'>
                <option value="---">- - - </option>
                <option value="Research" <?php if($Category == 'Research'){ echo ' selected="selected"'; }?> >Research</option>
                <option value="Teaching" <?php if($Category == 'Teaching'){ echo ' selected="selected"'; }?> >Teaching</option>
                <option value="Service" <?php if($Category == 'Service'){ echo ' selected="selected"'; }?> >Service</option>
                <option value="Lifetime" <?php if($Category == 'Lifetime'){ echo ' selected="selected"'; }?> >Lifetime</option>
            ...
            <select name="status" id="status" value='<?php echo $Status ?>'>
                <option value="---">- - - </option>
                <option value="Research" <?php if($Status == 'Research'){ echo ' selected="selected"'; }?> >Received</option>
                <option value="Teaching" <?php if($Status == 'Teaching'){ echo ' selected="selected"'; }?> >Nominated</option>
            </select><br>
        ...
        <?php 
        echo "
        <a href='l_honors.php'>Return to List</a>
        </form>
        </div>
    </body>
</html>";
