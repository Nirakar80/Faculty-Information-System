...
<head>
   ...
   <link rel="stylesheet" href="rlist.css">
    ...
    <body>
        ...
        <div class="navbar">
            <ul>
            <li><a href="../Lists/l_articlesinproceedings.php">Back</a></li>  
        ...
        <div class="panel">
          ...
          <div class="card">
            <div class="container">
              ...
              <?php echo "<a href='u_articlesinproceedings.php?id=".$paperID."'><button>Edit</button></a>&nbsp;&nbsp;&nbsp;
              <a href='../modify/d_articlesinproceedings.php?id=".$paperID."'><button>Delete</button></a>" ?>
            </div>
          </div>
