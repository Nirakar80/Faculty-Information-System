...
<head>
   ...
   <link rel="stylesheet" href="rlist.css">
    ...
    <body>
        ...
        <a href="../forms/f_chapters.html"><button class="button">+ Add Chapter, Case, Reading, or Supplement</button></a>
        <a href="l_chapters.php" style="float: right;"><button class="button">Table View</button></a>
        </div>
        <!--End Buttons Area  -->
        ...
        <div class="panel">
          ...
          <div class="card">
            <div class="container">
              ...
              <?php echo "<p><a href='u_chapters.php?id=".$row['ID']."'>Edit</a>&nbsp;&nbsp;&nbsp;
              <a href='../modify/d_chapters.php?id=".$row['ID']."'>Delete</a></p></p>" ?>
            </div>
          </div>
