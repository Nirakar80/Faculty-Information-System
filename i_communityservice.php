...
<head>
   ...
   <link rel="stylesheet" href="rlist.css">
    ...
    <body>
        ...
        <a href="../forms/f_communityservice.html"><button class="button">+ Add New Community Service</button></a>
        <a href="l_communityservice.php" style="float: right;"><button class="button">Table View</button></a>
        </div>
        <!--End Buttons Area  -->
          ...
          while($row=mysql_fetch_assoc($sql)){?>
            ...
            <div class="card">
                <div class="container">
                    ...
                    <?php echo "
                    <p><a href='u_communityservice.php?id=".$row['csID']."'>Edit</a>&nbsp;&nbsp;&nbsp;
                    <a href='../modify/d_communityservice.php?id=".$row['csID']."'>Delete</a></p>" ?>
                </div>
            </div>
