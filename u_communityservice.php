...
<head>
  ...
  <body>
    ...
    <div class="main">
      ...
      <form action="../modify/up_communityservice.php" method="post">

        <label> Activity Type: </label>
        <select name="activity" id="activity">
            <option value="---">- - - </option>
            <option value="Committee Member" <?php if($Activity == 'Committee Member'){ echo ' selected="selected"'; }?> >Committee Member</option>
            <option value="Committte Chair" <?php if($Activity == 'Committte Chair'){ echo ' selected="selected"'; }?> >Committte Chair</option>
            <option value="Executive Board Member" <?php if($Activity == 'Executive Board Member'){ echo ' selected="selected"'; }?> >Executive Board Member</option>
            <option value="Other Community Service Activities" <?php if($Activity == 'Other Community Service Activities'){ echo ' selected="selected"'; }?>  >Other Community Service Activities</option>
        </select><br>

        <label> Organization/Institution: </label>
        <input type="text" name="org" value='<?php echo $Organization ?>'/><br>
        ...
        <?php 
            echo "
            <a href='l_communityservice.php'>Return to List</a>
            </form>
        </div>
    </body>
</html>";
