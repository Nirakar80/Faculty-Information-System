...
<html>
<head>
   <title>Research Reports Form</title>
  ...
  <body>
    <div class="main">
      <h1>Results</h1><hr>
      <br>
      <form action="../modify/up_researchreports.php" method="post">
        <label> Research Report Title:</label>
        <input type="text" name="researchReportTitle" maxlength="100" size="15" value='<?php echo $ResearchandReportTitle; ?>'/><br><br>        
        
        <label> Institution Submitted:</label>
        <input type="text" name="institutionSubmitted" maxlength="100" size="15" value='<?php echo $InstitutionSubmitted; ?>'/><br><br>
        ...
        <?php 
            echo "
            <a href='l_researchreports.php'>Return to List</a>
            </form>
        </div>
    </body>
</html>";
