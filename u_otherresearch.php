 ...
 <head>
  ...
  <body>
    <div class="main">
      ...
      <form action="../modify/up_otherresearch.php" method="post">
        <label> Title: </label>
        ...
        <select name="activity" id="activity">
            <option value="---">- - - </option>
            <option value="Citation of Work in Other Publications"  <?php if($ActivityType == 'Citation of Work in Other Publications'){ echo ' selected="selected"'; } ?>>Citation of Work in Other Publications</option>
            <option value="Newspaper Articles or Columns" <?php if($ActivityType == 'Newspaper Articles or Columns'){ echo ' selected="selected"'; } ?>>Newspaper Articles or Columns</option>
            <option value="Other Publications" <?php if($ActivityType == 'Other Publications'){ echo ' selected="selected"'; } ?>>Other Publications</option>
            <option value="Other Research Activities" <?php if($ActivityType == 'Other Research Activities'){ echo ' selected="selected"'; } ?>>Other Research Activities</option>
            <option value="Special Projects or Assignments" <?php if($ActivityType == 'Special Projects or Assignments'){ echo ' selected="selected"'; } ?>>Special Projects or Assignments</option>
            <option value="Web Publications" <?php if($ActivityType == 'Web Publications'){ echo ' selected="selected"'; } ?>>Web Publications</option>
        </select><br>
        
        <label> Year Submitted: </label>
        <input type="text" name="yearSubmitted" value='<?php echo $YearSubmitted; ?>'/><br>
        ...
        <textarea type="textarea" rows="11" cols ="80" name="desc" maxlength="250" value='<?php echo $Description; ?>'><?php echo $Description?></textarea><br><br>
        <input type="submit" name="submit" value="Update"/>
      
           
        <?php 
            echo "
            <a href='l_otherresearch.php'>Return to List</a>
            </form>
        </div>
    </body>
</html>";
