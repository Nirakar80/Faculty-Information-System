...
<html>
<head>
   <title>Articles in Proceedings Form</title>
  ...
  <body>
    <div class="main">
      <h1> Results</h1><hr>
      <br>
      <form action="../modify/up_articlesinproceedings.php" method="post">
        ...
        <input type="text" name="conference" maxlength="15" size="15" value='<?php echo $Conference; ?>'/><br><br>
        ...
        <select name="inclusion" id="inclusion">
          <option value="---">- - - </option>
          <option value="Full Paper" <?php if($Inclusion == 'Full Paper'){ echo ' selected="selected"'; } ?>>Full Paper</option>
          <option value="Abstract" <?php if($Inclusion == 'Abstract'){ echo ' selected="selected"'; } ?>>Abstract/Summary Only</option>
        </select><br><br>
        ...
        <?php 
            echo "
            <a href='l_articlesinproceedings.php'>Cancel</a>
            </form>
        </div>
    </body>
        </html>";
